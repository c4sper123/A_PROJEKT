...
public class WinterOffersWindow extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_winter_offers_window, container, false);
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                    ...
                    for(int i=0;i<data.length();i++){
                        ...
                        if(offerObject.getJSONArray("categories").getJSONObject(0).getString("mainCategory").equals("Zima")){
